...
const div3 = [...pokémon].filter( pok => pok.id%3 === 0);
console.log(div3);
//     an array of pokémon objects that are "fire" type
const fire = [...pokémon].filter( pok => pok.types.includes("fire"));
console.log(fire);
//     an array of pokémon objects that have more than one type
const multiType = [...pokémon].filter( pok => pok.types.length > 1);
...
const fly = [...pokémon].filter( pok => pok.types==="flying" ).map( pok => pok.types[0]);
console.log(fly);
